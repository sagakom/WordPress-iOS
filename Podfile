...
def wordpress_kit
    pod 'WordPressKit', '~> 4.1.0-beta.2'
    #pod 'WordPressKit', :git => 'https://github.com/wordpress-mobile/WordPressKit-iOS.git', :commit => '0377092f77abb39065f43d6a028dd59a8ecb6aed'
...
target 'WordPress' do
    ...
    pod 'WordPressAuthenticator', :git => 'https://github.com/wordpress-mobile/WordPressAuthenticator-iOS.git', :commit => '7b7d6d9a79e747eba2a0bf9684826ac473362b31'
